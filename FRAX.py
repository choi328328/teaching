...
class TestFRAX():
  ...
  def calculate_frax(self, 
    ...
    dropdown.find_element(By.XPATH, f"//option[. = '{femoral_method}']").click()
    self.driver.switch_to.alert.dismiss()
    # with contextlib.suppress(Exception):
    #   self.driver.switch_to.alert
    #   self.driver.find_element(By.ID, "ctl00_ContentPlaceHolder1_bmd_input").send_keys(Keys.ENTER)
      
    self.driver.find_element(By.ID, "ctl00_ContentPlaceHolder1_bmd_input").clear()
    self.driver.find_element(By.ID, "ctl00_ContentPlaceHolder1_bmd_input").send_keys(femoral_value)
    self.driver.find_element(By.ID, "ctl00_ContentPlaceHolder1_btnCalculate").click()
    with contextlib.suppress(Exception):
      self.driver.switch_to.alert
      return None, self.driver.switch_to.alert.text
    self.driver.implicitly_wait(time_to_wait=5)

    osteo=self.driver.find_element(By.CSS_SELECTOR, ".result-box:nth-child(2) .result-score").text
    fracture = self.driver.find_element(By.CSS_SELECTOR, ".result-box:nth-child(3) .result-score").text
