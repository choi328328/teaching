...
base_path = '/Users/choibyungjin/Library/CloudStorage/OneDrive-아주대학교/study/teaching/gadgets'
aa = r(f'''
library(metafor)
par(mar=c(1,1,1,1))
tt= read.csv('{base_path}/results/temp_results.csv')
...
pdf(file='{base_path}/results/forest_random.pdf')
...
pdf(file='{base_path}/results/forest_fixed.pdf')
