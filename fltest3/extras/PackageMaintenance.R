...
OhdsiRTools::checkUsagePackage("fltest3")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/fltest3.pdf")
shell("R CMD Rd2pdf ./ --output=extras/fltest3.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("fltest3")
